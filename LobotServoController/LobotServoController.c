...
/*********************************************************************************
 * Function:    setServoMotorMode
 * Description： 设置指定舵机为电机模式并控制其转速
 * Parameters:    servoID: 舵机ID号, Speed: 转动速度
 * 舵机ID取值范围: 0 ~ 31
 * Speed取值范围: -1000 ~ 1000, 负数值代表反转，正数值代表正转
 * Return:      无返回
